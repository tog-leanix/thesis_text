...
\def\ThesisTitle{User interface standardization of Software as a Service products}
...
\input{chapter_1/index} 
\input{chapter_2/index} 
\input{chapter_3/index} 
\input{chapter_4/index} 
\input{chapter_5/index} 
\input{chapter_6/index} 
